...
SELECT * FROM DEPARTAMENTO INNER JOIN PROFESOR ON DEPARTAMENTO.ID=PROFESOR.ID_DEPARTAMENTO INNER JOIN ASIGNATURA ON PROFESOR.ID_PROFESOR=ASIGNATURA.ID_PROFESOR INNER JOIN GRADO WHERE GRADO.NOMBRE ='Grado en Ingeniería Informática (Plan 2015)';


SELECT * FROM ALUMNO_SE_MATRICULA_ASIGNATURA INNER JOIN CURSO_ESCOLAR WHERE ANYO_INICIO='2018';



/*LEFT-RIGHT*/
SELECT * FROM PROFESOR LEFT JOIN DEPARTAMENTO ON DEPARTAMENTO.ID=PROFESOR.ID_DEPARTAMENTO LEFT JOIN PERSONA ON PERSONA.ID=PROFESOR.ID_PROFESOR ORDER BY PERSONA.APELLIDO1,PERSONA.APELLIDO2,PERSONA.NOMBRE ASC ;
SELECT APELLIDO1,APELLIDO2,PERSONA.NOMBRE FROM PERSONA RIGHT JOIN PROFESOR ON PROFESOR.ID_PROFESOR=PERSONA.ID LEFT JOIN DEPARTAMENTO ON DEPARTAMENTO.ID=PROFESOR.ID_PROFESOR WHERE DEPARTAMENTO.NOMBRE='% %';
