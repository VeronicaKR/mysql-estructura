...
('2','PIZZAS DIFICILES');
INSERT INTO PRODUCTO (TIPO_PRODUCTO,ID_PRODUCTO,NOM,DESCRIPCIO,IMATGE,PREU,ID_CATEGORIA_PIZZAS)
VALUES ('PIZZA','1','MARGARITA','QUESO Y TOMATE','1','10','1');

INSERT INTO PRODUCTO (TIPO_PRODUCTO,ID_PRODUCTO,NOM,DESCRIPCIO,IMATGE,PREU)
VALUES ('HAMBURGUESA','2','COMPLETA','QUESO Y TOMATE','NULL','10'),
('BEBIDA','3','COCACOLA','QUESO Y TOMATE','NULL','10'); 
...
('3','4','2022-06-02 10:43:43','ENTREGA','3','20','3','3','60');
INSERT INTO DETALLE_COMANDA (ID_DETALLE_COMANDA,ID_COMANDA,ID_PRODUCTO)
VALUES ('1','1','1'),
('1','1','3'),
('2','2','2');
...
SELECT * FROM COMANDA INNER JOIN LOCALITAT ON LOCALITAT.ID_CLIENT=COMANDA.ID_CLIENT WHERE TIPO_PRODUCTO=3;
