...
INSERT INTO PIZZAS(ID_PIZZA,NOM,DESCRIPCIO,IMATGE,PREU,TIPO_PRODUCTO,ID_CATEGORIA_PIZZAS)
VALUES ('1','MARGARITA','TOMATE Y QUESO', 'NULL','20', '1','1'),
('2','PROSCUITO','TOMATE, QUESO,JAMON DULCE', 'NULL','20', '1','2'),
('3','CARBONARA','NATA,BEICON Y QUESO', 'NULL','20', '1','1'),
('4','HAWAIANA','TOMATE Y PIÑA', 'NULL','20', '1','2');

INSERT INTO HAMBURGUESAS(ID_HAMBURGUESA,NOM,DESCRIPCIO,IMATGE,PREU,TIPO_PRODUCTO)
VALUES('1','PEQUE','PAN,TOMATE,HAMBURGUESA','NULL','20','2'),
('2','MEDIANA','PAN,TOMATE,QUESO,HAMBURGUESA','NULL','20','2'),
('3','COMPLETA','PAN,TOMATE,,LECHUGA,QUESO,HAMBURGUESA','NULL','20','2');

INSERT INTO BEBIDAS (ID_BEBIDA,NOM,DESCRIPCIO,IMATGE,PREU,TIPO_PRODUCTO)
VALUES('1','COCA-COLA','BEBIDA CON GAS','NULL','5','3'),
('2','FANTA','BEBIDA CON GAS','NULL','5','3'),
('3','AQUARIUS','BEBIDA SIN GAS','NULL','5','3');
