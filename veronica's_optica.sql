...
('PORTUGUES','OPORTO','2','B','43721','PORTUGAL','977777778','977777773', 'B55503679'),
('FRANCES','BEACOUP','3','C','43722','FRANCIA','977777779','977777774', 'B55503679'),
('ESPAÑOL','ROCBORONAT','4','D','43723','ESPAÑA','977777770','977777775', 'B55503670');
...
('2','OACKLEY','2','2','PASTA','NEGRA','BLANCO','100'),
('3','RAYBAN','2','2','PASTA','NEGRA','BLANCO','100'),
('4','RALPH','2','2','PASTA','NEGRA','BLANCO','100');
INSERT INTO CLIENTES (NOMBRE,CP,TELEFONO,MAIL,FECHA_REGISTRO,RECOMENDADO_POR)
VALUES ('JUAN','43700','977777777','MAIL','22-01-01','1'),
('JUANA','43700','977777777','MAIL','22-01-01','1'),
('JUANITO','43700','977777777','MAIL','22-01-01','2');
INSERT INTO VENTAS (TRABAJADOR,FECHA_VENTA,MARCA, ID_PROVEEDOR,ID_CLIENTE)
VALUES ('PEP','22-01-01','TOUS','1','1'),
('PEP','22-01-01','TOUS','1','2'),
('LOL','22-01-01','RAYBAN','3','1'),
('LOLA','22-01-01','OACKLEY','2','3');
...
SELECT PROVEEDOR.ID_PROVEEDOR,VENTAS.ID_PROVEEDOR,NOMBRE,FECHA_VENTA,MARCA FROM PROVEEDOR INNER JOIN VENTAS ON PROVEEDOR.ID_PROVEEDOR = VENTAS.ID_PROVEEDOR ;
